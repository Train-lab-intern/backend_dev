    ...
    static Stream<Arguments> paramsWithExceptions() {
        return Stream.of(
                ...
                Arguments.of(UserCreateDto.builder()
                        ...
                        "Invalid password. The password must be typed in Latin letters, consist of at least 8 characters " +
                        "and contain at least one lowercase and one uppercase character"),
                Arguments.of(UserCreateDto.builder().email("vlad@gmailcom").password("1234a").build(),
                        "Invalid email and password. The password must be typed in Latin letters, consist of at least 8 " +
                        "characters and contain at least one lowercase and one uppercase character")
        );
    }
